...
def main():
    ...
    logger.info("--- COPY MODE: GIỮ NGUYÊN CHẤT LƯỢNG ---")
    logger.info(f"Luồng xử lý: {NUM_WORKERS}")
    logger.info(f"Số video: {len(video_files)}")
    ...
    logger.info(f"--- HOÀN TẤT {count} VIDEO ---")
